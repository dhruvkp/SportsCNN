...
def densenet121_model(img_rows, img_cols, color_type=1, nb_dense_block=3, growth_rate=12, nb_filter=64, reduction=0.0, dropout_rate=0.0, weight_decay=1e-4, num_classes=None):
    '''
    ...
    x = Conv2D(nb_filter, (3, 3), strides=(2, 2), name='conv1', use_bias=False,kernel_regularizer=l2(weight_decay))(x)
    ...
    if K.image_dim_ordering() == 'th':
      ...
      weights_path = 'imagenet_models/DenseNet-40-12-CIFAR10.h5'
...
if __name__ == '__main__':
    ...
    train_generator = train_datagen.flow_from_directory(
        directory=r"../datasets/train/",target_size=(224, 224),color_mode="rgb",batch_size = 16,
        class_mode = "categorical",shuffle = True,seed = 42)

    # test_generator = test_datagen.flow_from_directory(
    #     directory=r"./data/test/", target_size=(224, 224), color_mode="rgb",
